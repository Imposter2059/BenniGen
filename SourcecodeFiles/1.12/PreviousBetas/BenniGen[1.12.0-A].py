...
class NitroGenApp:
    ...
    def show_changelog(self):
        messagebox.showinfo("Changelog", "- Update v1.12.0-A -\n"
                                         "- Moderate Patches -\n\n"
                                         "- Added Changelog\n"
    ...
    def show_version(self):
        messagebox.showinfo("Version Display", "Model Version -:- v1.12(.0-A)\n"
                                              "- Core Edition\n"
                                              "Advanced Version ID -:- v1.12.0-A")

    def show_primary_functions(self):
        num = int(messagebox.askinteger("Primary Functions", "Input How Many Codes to Generate and Check:"))
        ...
        result_message = f"Generated {num} codes | Valid codes: {len(valid_codes)}\n\n"
        result_message += "\n".join([f"{'Valid' if code in valid_codes else 'Invalid'} | {code}" for code in generated_codes])

        messagebox.showinfo("Code Generation Result", result_message)
